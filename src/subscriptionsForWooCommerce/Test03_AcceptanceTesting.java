...
public class Test03_AcceptanceTesting {
	...
	public static void main(String[] args) {
		...
		// Verifying availability of Subscriptions table, Bulk actions, search box, and table headings.
		...
		assertTrue(driver.findElement(By.xpath("//table[@class='wp-list-table widefat fixed striped table-view-list makewebbetter_page_subscriptions_for_woocommerce_menu']")).isDisplayed());
		System.out.println("Pass");
		assertTrue(driver.findElement(By.xpath("//th[@id='subscription_id']//span[contains(text(),'Subscription ID')]")).isDisplayed());
		System.out.println("Pass1");
		assertTrue(driver.findElement(By.xpath("//th[@id='parent_order_id']//span[contains(text(),'Parent Order ID')]")).isDisplayed());
		...
		assertTrue(driver.findElement(By.xpath("//tfoot//th[@class='manage-column column-product_name'][normalize-space()='Product Name']")).isDisplayed());
		System.out.println("Pass12");
		assertTrue(driver.findElement(By.xpath("//tfoot//th[@class='manage-column column-recurring_amount'][normalize-space()='Recurring Amount']")).isDisplayed());
		System.out.println("Pass13");
		assertTrue(driver.findElement(By.xpath("//tfoot//th[@class='manage-column column-user_name'][normalize-space()='User Name']")).isDisplayed());
		System.out.println("Pass14");
		assertTrue(driver.findElement(By.xpath("//tfoot//th[@class='manage-column column-next_payment_date'][normalize-space()='Next Payment Date']")).isDisplayed());
		System.out.println("Pass15");
		assertTrue(driver.findElement(By.xpath("//tfoot//th[@class='manage-column column-subscriptions_expiry_date'][normalize-space()='Subscription Expiry Date']")).isDisplayed());
