...
public class Test01_ActivateDeactivate {
	...
	public static void main(String[] args) {
		...
		// To test the Activation and Deactivation of Subscriptions For WooCommerce
		// Plugin with onboarding and deactivation form working
		...
		assertTrue(driver
				.findElement(
						By.xpath("//tr[@data-slug='subscriptions-for-woocommerce']//a[contains(text(),'Settings')]"))
				.isDisplayed());
		...
		assertTrue(driver.findElement(By.xpath(
				"//a[@href='https://makewebbetter.com/?utm_source=MWB-subscriptions-backend&utm_medium=MWB-ORG-backend&utm_campaign=MWB-backend']"))
				.isDisplayed());
		assertTrue(
				driver.findElement(By.xpath("//a[@aria-label='More information about Subscriptions For WooCommerce']"))
						.isDisplayed());
		...
		try {
			...
			if (deactivation.isDisplayed() == true) {
				...
				driver.findElement(By.xpath("//textarea[@id='mwb-sfw-deactivation-reason-text']"))
						.sendKeys("Chirag Gupta QA");
				driver.findElement(By.cssSelector("input[value='Send Us']")).click();
				// driver.findElement(By.xpath("//a[normalize-space()='Skip and Deactivate
				// Now']")).click();
