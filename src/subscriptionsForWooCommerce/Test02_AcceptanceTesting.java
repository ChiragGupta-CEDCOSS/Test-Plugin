...
public class Test02_AcceptanceTesting {
	...
	public static void main(String[] args) {
		...
		assertTrue(
				driver.findElement(By.xpath("//label[normalize-space()='Check this box to enable the subscription.']"))
						.isDisplayed());
		...
		assertTrue(driver
				.findElement(By.xpath("//div[contains(text(),'Use this option to change add to cart button text.')]"))
				.isDisplayed());
		...
		assertTrue(driver
				.findElement(By.xpath("//div[contains(text(),'Use this option to change place order button text.')]"))
				.isDisplayed());
		...
		assertTrue(driver.findElement(By.xpath("//label[normalize-space()='Allow Customer to cancel Subscription']"))
				.isDisplayed());
		assertTrue(driver
				.findElement(By.xpath("//label[contains(text(),'Enable this option to allow the customer to cancel')]"))
				.isDisplayed());
